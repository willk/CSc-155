package code.p41.InterpolatedCube;
...
public class Code extends JFrame implements GLEventListener {
    ...
    private int createShaderPrograms(GLAutoDrawable drawable) {
        ...
        String vshaderSource[] = GLSLUtils.readShaderSource("src/code/p41/InterpolatedCube/default_vertex.glsl");
        String fshaderSource[] = GLSLUtils.readShaderSource("src/code/p41/InterpolatedCube/default_fragment.glsl");
        int lengths[];
