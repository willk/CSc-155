...
public class Code extends JFrame implements GLEventListener {
    ...
    private int createShaderPrograms(GLAutoDrawable drawable) {
        ...
        String vshaderSource[] = GLSLUtils.readShaderSource("src/code/p41/PlainRedCube/default_vertex.glsl");
        String fshaderSource[] = GLSLUtils.readShaderSource("src/code/p41/PlainRedCube/default_fragment.glsl");
        int lengths[];
